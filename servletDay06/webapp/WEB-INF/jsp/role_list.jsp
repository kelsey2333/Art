...
<div id="main">
    <form action="" method="">
        ...
        <div class="search_add">
            <a href="<%=request.getContextPath()%>/add.role"><input type="button" value="增加" class="btn_add"/></a>
        </div>
        <!--删除的操作提示-->
        ...
        <div id="data">
            <table id="datalist">
                ...
                <tr>
                    ...
                    <td>
                        <a href="http://localhost:8080/servletDay06/modi.role?roleName=<%=allRoles.getRoleName()%>&powerName=<%=allRoles.getPowerNames()%>"><input type="button" value="修改" class="btn_modify" /></a>
