            ...
            <form action="http://localhost:8080/servletDay06/modi.role" method="get" class="main_form">
                ...
                <div class="input_info_high">
                    <div class="input_info_scroll">
                        <ul>
                            <li><input name="powerName" value="2" type="checkbox" />管理员管理</li>
                            <li><input name="powerName" value="1" type="checkbox" />角色管理</li>
                            <li><input name="powerName" value="3" type="checkbox" />资费管理</li>
                            <li><input name="powerName" value="4" type="checkbox" />账务账号</li>
                            <li><input name="powerName" value="5" type="checkbox" />业务账号</li>
                            <li><input name="powerName" value="6" type="checkbox" />账单</li>
                            <li><input name="powerName" value="7" type="checkbox" />报表</li>
                        </ul>
                    </div>
                    <span class="required">*</span>
